...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col  justify-center h-full px-6 md:px-20 text-white ">
        ...
        <div className="flex flex-wrap items-center gap-6 opacity-80 w-full mt-9">
          <Marquee>
            {arrayofLogo.map((logo, index) => {
              return (
